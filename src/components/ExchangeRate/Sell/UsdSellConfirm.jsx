...
const UsdSellConfirm = () => {
  const location = useLocation();
  const navigate = useNavigate();
  const { usdAmount, targetRate } = location.state;

  const finalAmount = (parseFloat(usdAmount) * parseFloat(targetRate)).toFixed(
    2
  );
  ...
  return (
    <div style={styles.container}>
      ...
      <p style={styles.confirmText}>
        ...
        <br />
        <span style={styles.highlight}>${usdAmount}</span>을{" "}
